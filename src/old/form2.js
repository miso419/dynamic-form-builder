...
export default class ReactForm extends React.Component {
    ...
    constructor(props) {
        ...
        props.onChange && this.handleChange.bind(props.onChange);
        this.handleSubmit.bind(this.props);
        props.onValidateForm && this.validateForm.bind(props.onValidateForm);
    }
    ...
    validateForm() {
        ...
        this.props.onValidateForm && this.props.onValidateForm(errors, data_items);
